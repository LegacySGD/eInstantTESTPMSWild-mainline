...
public class TESTPMSWildEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(TESTPMSWildEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/TESTPMSWildIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/TESTPMSWildIW/InitOutcome.xml").getDocumentElement();
